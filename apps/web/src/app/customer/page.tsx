                ...
                {activeOrders.slice(0, 4).map((order) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-[#e1e3e1] p-6 rounded-xl"
                    >
                      <div className="flex justify-between items-start mb-6">
                        ...
                        <span className="px-3 py-1 bg-[#006a4e] text-[#9ef4d0] rounded-full text-[10px] font-bold uppercase tracking-tighter">
                          {statusLabels[order.status as string] || "En cours"}
                        </span>
                      </div>
                      <div className="space-y-3">
                        ...
                        <div className="h-2 w-full bg-[#edeeec] rounded-full overflow-hidden">
                          <div
                            className="h-full bg-[#00503a] rounded-full"
                            style={{ width: `${progress}%` }}
                          ></div>
                        </div>
                        <p className="text-[11px] text-slate-500 italic mt-2 flex items-center gap-1">
                          <MapPin className="text-xs" /> Le livreur est en route
                        </p>
                      </div>
                    </div>
                  );
            ...
            <div className="space-y-2">
              {orders
                ...
                .map((order) => (
                  <div
                    key={order.id as string}
                    className="group flex flex-col md:flex-row md:items-center justify-between p-5 bg-white hover:bg-emerald-50/50 transition-colors rounded-xl gap-4"
                  >
                    <div className="flex items-center gap-6">
                      <div className="text-center min-w-[48px]">
                        ...
                        <p className="text-xl font-black text-[#191c1b]">
                          {getDay(order.createdAt as string)}
                        </p>
                      </div>
                      <div>
                        <h4 className="font-bold text-[#191c1b]">
                          {(order.type as string) || "Colis"}
                        </h4>
                        <p className="text-xs text-slate-500">
                          De:{" "}
                          {(order.pickupNeighborhood as string) ||
                            "Point relais"}{" "}
                          — À: {order.deliveryNeighborhood as string}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between md:justify-end gap-12">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <Link
                          ...
                          className="p-2 group-hover:bg-emerald-100 rounded-lg transition-all"
                        >
