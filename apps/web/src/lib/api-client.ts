...
export const authApi = {
  ...
  refreshTokens: (refreshToken: string) => apiClient.post("/auth/refresh", { refreshToken }),
...
export const ordersApi = {
  ...
  getRiderOrders: (params?: unknown) => apiClient.get("/orders/rider/mine", { params }),
  // Admin
...
export const paymentsApi = {
  ...
  verify: (orderId: string) => apiClient.get(`/payments/order/${orderId}/verify`),
};

export const ridersApi = {
  register: (data: unknown) => apiClient.post("/riders/register", data),
  getMe: () => apiClient.get("/riders/me"),
  updateStatus: (status: string) => apiClient.patch("/riders/me/status", { status }),
  updateLocation: (location: unknown) => apiClient.post("/riders/me/location", { location }),
